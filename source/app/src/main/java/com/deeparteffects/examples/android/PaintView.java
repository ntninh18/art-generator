...
public class PaintView extends View {
    ...
    public void saveImage() {
        ...
        File subDirectory = new File(sdDirectory.toString() + "/Pictures/ArtGenerator");
        ...
        if (subDirectory.exists()) {
            ...
            File image = new File(subDirectory, "/zpainting-" + (count + 1) + ".png");
            ...
            try {
                ...
                Toast.makeText(getContext(), "Painting saved", Toast.LENGTH_LONG).show();
